...
/**
   The dispatch queue in which notifications will be posted on. Defaults to the main dispatch queue.
 */
@property (nonatomic, strong) dispatch_queue_t notificationDispatchQueue;
